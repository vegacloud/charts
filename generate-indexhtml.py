...
# Install the latest version of the metrics agent
...
helm install vega-metrics vegacloud/vega-metrics-agent --version 1.0.0 \
  --set vega.clientId="your-client-id" \
  --set vega.clientSecret="your-client-secret" \
  --set vega.orgSlug="your-org-slug" \
  --set vega.clusterName="your-cluster-name"
...
helm upgrade vega-metrics vegacloud/vega-metrics-agent --version 1.0.0</code></pre>
        </div>
    </section>
